...
def main():
    ...
    k_boundary, l_boundary = 1, 1 # Boundary in kspace
    h = 3 # H plane in kspace (r.l.u)
    diff = 0.01 # Distance between kspace-points
    k0, l0 = 3, -8  # centering of kspace in (r.l.u.)
    n, k2d, l2d = kspacecreator(k_boundary, l_boundary, diff, k0, l0)
    ### For CDW Plot
    a = 4.35 # in Å
    c = 10.9  # in Å
    z0 = 0.385 # 4e Wyckoff degree of freedom
    ### INPUT FOR DBW
