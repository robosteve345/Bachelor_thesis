"""Simulation of CDW pattern in k-space for 10 unit cells of EuGa2Al2 with symmetry I4/mmm
"""
import numpy as np
...
def main():
    ...
    atoms_list = [F_Eu_list, F_Eu_T_list, F_Ga1_list, F_Ga1_T_list, F_Ga2_list, F_Ga2_T_list, F_Al1_list, F_Al1_T_list, F_Al2_list, F_Al2_T_list]
