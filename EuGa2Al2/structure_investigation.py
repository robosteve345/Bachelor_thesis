...
def main():
    ...
    # ax1.set_title(r'EuGa$_2$Al$_2$', fontsize=32, style='oblique')
    # ax1.set_yticks([])
    ...
    # plt.tight_layout()
    # plt.savefig("stavinoah1_euga2al2_1_Version2.jpg", dpi=300)
    # #
    # fig, ax1 = plt.subplots()
    # fig.subplots_adjust(right=0.75)
    # tkw = dict(size=4, width=1.5)
    ...
    # # ax2.text(x=220, y=2.525, s=r'(b)', style='oblique', fontsize=27)
    # ax2.legend(fontsize=27, loc='lower right')
    # plt.tight_layout()
    # plt.savefig("stavinoah1_euga2al2_2_Version2.jpg", dpi=300)
    #
    # fig, ax1 = plt.subplots()
    # fig.subplots_adjust(right=0.75)
    # tkw = dict(size=4, width=1.5)
    ...
    # # ax2.text(x=255, y=111.525, s=r'(c)', style='oblique', fontsize=27)
    # # ax2.locator_params(axis='y', nbins=3)
    ...
    #
    # ax1.set_xlabel(r'$T$(K)', fontsize=30)
    # ax1.set_title(r'EuGa$_4$', fontsize=32, style='oblique')
    # ax1.set_ylim(4.2, 4.5)
    # ax1.set_ylabel(r'$a$(Å)', color='b', fontsize=30)
    ...
    # ax2.plot(np.linspace(80, 310, 1000), m * np.linspace(80, 310, 1000) + t, lw=1.5, c='g', ls='-')
    # print("c: m={}+-{}, t={}+-{}".format(m, sigma_m, t, sigma_t))
    # ax2.errorbar(T2, c2, yerr=dc2, color='g', linestyle='', lw=0.8, marker='s', markersize=12, capsize=4, label=r'$c$')
    # # ax2.set_ylabel(r'$c$(Å)', color='g', fontsize=30)
    # # ax2.tick_params(axis='y', labelcolor='g', labelsize=30, **tkw)
    # # ax2.text(x=210, y=10.678, s=r'(a)', style='oblique', fontsize=27)
    # # ax2.text(x=80, y=10.665, s=r'EuGa$_4$', style='italic', fontsize=30, fontweight='bold')
    # ax2.legend(fontsize=27, loc='lower right')
    # plt.tight_layout()
    # plt.savefig("stavinoah1_euga4_1_Version2.jpg", dpi=300)
    #
    # fig, ax1 = plt.subplots()
    # fig.subplots_adjust(right=0.75)
    # tkw = dict(size=4, width=1.5)
    ...
    # ax2.plot(np.linspace(80, 310, 1000), m * np.linspace(80, 310, 1000) + t, lw=1.5, c='y', ls='-')
    # print("d22: m={}+-{}, t={}+-{}".format(m, sigma_m, t, sigma_t))
    # ax2.errorbar(T2, D22, yerr=dD22, color='y', linestyle='', lw=0.8, marker='s', markersize=12, capsize=4, label=r'$d_{22}$')
    # # ax2.set_ylabel(r'$d_{22}$(Å)', color='y', fontsize=30)
    # # ax2.tick_params(axis='y', labelcolor='y', labelsize=30, **tkw)
    # # ax2.locator_params(axis='y', nbins=3)
    # # ax2.text(x=240, y=2.4967, s=r'(b)', style='oblique', fontsize=27)
    # ax2.legend(fontsize=27, loc='lower right')
    # plt.tight_layout()
    # plt.savefig("stavinoah1_euga4_2_Version2.jpg", dpi=300)
    #
    # fig, ax1 = plt.subplots()
    # fig.subplots_adjust(right=0.75)
    # tkw = dict(size=4, width=1.5)
    ...
    # ax2.plot(np.linspace(80, 310, 1000), m * np.linspace(80, 310, 1000) + t, lw=1.5, c='c', ls='-')
    # print("theta: m={}+-{}, t={}+-{}".format(m, sigma_m, t, sigma_t))
    # ax2.errorbar(T2, Theta, yerr=dTheta, color='c', linestyle='', lw=0.8, marker='s', markersize=12, capsize=4, label=r'$\theta$')
    # # ax2.set_ylabel(r'$\theta$(°)', color='c', fontsize=30)
    # # ax2.tick_params(axis='y', labelcolor='c', labelsize=30, **tkw)
    # # ax2.text(x=100, y=114.12, s=r'(c)', style='oblique', fontsize=27)
    # # ax2.locator_params(axis='y', nbins=3)
    # ax2.legend(fontsize=27, loc='lower center')
    # plt.tight_layout()
    # ax2.set_yticks([])
    # ax2.set_ylim(110.7, 114.4)
    # plt.savefig("stavinoah1_euga4_3_Version2.jpg", dpi=300)
    # # m, sigma_m, dm, t, sigma_t, dt = lin_reg(T, V, dy=np.zeros(4), sigma_y=dV, plot=False)
    # # print("V: m={}+-{}, t={}+-{}".format(m, sigma_m, t, sigma_t))
